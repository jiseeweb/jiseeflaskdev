...
from flask_sample import  db, bcrypt, mail
from flask_sample.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm, ResetRequestForm, ResetPasswordForm)
from flask_sample.models import User, Post
from flask_login import login_user, current_user, logout_user, login_required
from flask_sample.users.utils import photo_save, send_reset
...
def login():
	...
	if form.validate_on_submit():
		...
		if user and bcrypt.check_password_hash(user.password, form.password.data):
			...
			return redirect(next_page) if next_page else redirect(url_for('main.home_page')) # Ternary Conditional
		else:
